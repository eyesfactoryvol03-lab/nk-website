/**
 * Unsplash（https://unsplash.com）のフリー素材。
 * Unsplash ライセンスに基づき利用（https://unsplash.com/license）
 */
export const STOCK_IMAGES = {
  ...
  work2:
    "https://images.unsplash.com/photo-1541976590-713941aba591?auto=format&fit=crop&w=900&q=80",
  work3:
